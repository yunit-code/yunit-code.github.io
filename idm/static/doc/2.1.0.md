...
<font color="#CCCCCC">用于设置开启是否表单类的页面以及表单模式下相关的基本设置信息分组</font>
...
<font color="#CCCCCC">用于设置表单加载相关的配置信息</font>
...
<font color="#CCCCCC">用于设置表单加载请求的结果值映射对象配置</font>
...
<font color="#CCCCCC">用于设置接口请求所需要的额外参数，其中该接口默认带有__formData和formId参数，分别取自url参数和页面ID</font>
...
<font color="#CCCCCC">用于设置表单保存相关的配置信息</font>
...
<font color="#CCCCCC">用于设置接口保存所需要的额外参数</font>
